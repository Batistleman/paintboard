...
init=true
/*image = _.getimageData(0,0, width, height);
...
function skinfilter(){
        ...
        for (var y=0 ; y<height ; y++)
        {
                for (var x=0 ; x<width ; x++)
                {
						...
						if(r > 200 && g < 100 && b < 100){
								...
								image.data[count_data_big_array]=r
                                image.data[count_data_big_array+1]=g
                                image.data[count_data_big_array+2]=b
                                image.data[count_data_big_array+3]=a
                        }else{
								...
								/*image.data[count_data_big_array]=0
                                image.data[count_data_big_array+1]=0
                                image.data[count_data_big_array+2]=0
                                image.data[count_data_big_array+3]=0*/
                        }
        ...
        //draw=skin_filter
		draw=image
		//_.putImageData(skin_filter,0,0)
		_.putImageData(image,0,0)
